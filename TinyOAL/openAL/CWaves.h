...
public:
	...
	WAVERESULT LoadWaveFile(void* source, WAVEID *WaveID, wav_callbacks& callbacks);
	WAVERESULT OpenWaveFile(void* source, WAVEID *WaveID, wav_callbacks& callbacks);
	...
	WAVERESULT GetWaveBitsPerSample(WAVEID WaveID, unsigned short *pusBitsPerSample);
  ...
  //---Custom---
  LPWAVEFILEINFO* GetWaveInfo(WAVEID WaveID);
  //---End Custom---
...
private:
	WAVERESULT ParseFile(void* source, LPWAVEFILEINFO pWaveInfo, wav_callbacks& callbacks);
