...
#ifndef __AUDIO_RESOURCE_FLAC_H__TOAL__
#define __AUDIO_RESOURCE_FLAC_H__TOAL__
...
namespace tinyoal {
  ...
  public:
    ...
    AudioResourceFLAC(void* data, unsigned int datalength, TINYOAL_FLAG flags, uint64_t loop);
    ~AudioResourceFLAC();
